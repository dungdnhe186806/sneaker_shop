    ...
    <div class="clickalbe-sidebar-wrap">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-menu-wrap mobile-header-padding-border-2">
                <nav>
                    <ul class="mobile-menu">
                        <li class="menu-item-has-children"><a href="Home.jsp">Home</a>
            ...
            <div class="mobile-contact-info mobile-header-padding-border-4">
                <ul>
                    <li><i class="icon-phone "></i> (+84) 12345678</li>
                    <li><i class="icon-envelope-open "></i> group5@gmail.com</li>
                    <li><i class="icon-home"></i> HOA LAC HI TECK , THACH THAT , HA NOI</li>
                </ul>
            </div>
