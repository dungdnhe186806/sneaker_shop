                        ...
                        <div class="tile">
                            ...
                            <div class="tile-body">
                                <div class="row element-button">
                                    <div class="col-sm-2">
                                        <a class="btn btn-add btn-sm" data-bs-toggle="modal" data-bs-target="#adddanhmuc"><i
                                                class="fas fa-folder-plus"></i> Thêm danh mục</a>
                                    </div>
                                </div>

                                <form class="row" action="productmanager" method="POST" >
                                    <input type="text" hidden name="action" value="insertproduct">
                                    <div class="form-group col-md-3">
                                        <label class="control-label">Mã sản phẩm </label>
                                        <input class="form-control" name="product_id" type="text" placeholder="" readonly value="${currentId+1}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="exampleSelect1" class="control-label">Danh mục</label>
                                    <select name="category_id" class="form-control" id="exampleSelect1" required>
                                        <optgroup label="---Chọn 1 danh mục---">
                                ...
                                <div class="form-group  col-md-3">
                                    ...
                                    <input class="form-control" name="product_price" type="number" step="0.01" min="0" required>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Size</label>
                                    <input class="form-control" name="product_size" type="text" placeholder="S,L,XL,...">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Màu</label>
                                    <input class="form-control" placeholder="Blue,Gray,..." name="product_color" type="text">
                                </div>
                                <div class="form-group  col-md-3">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" name="product_describe" id="describe"></textarea>
                                </div>
                                <button class="btn btn-save" id="submitButton" type="submit">Lưu lại</button>
                                &nbsp;
